-- Corrigir função get_complete_schema para adicionar search_path seguro
CREATE OR REPLACE FUNCTION public.get_complete_schema()
RETURNS jsonb
LANGUAGE plpgsql
SECURITY DEFINER
SET search_path = public  -- Adiciona proteção de segurança
AS $function$
DECLARE
    result jsonb;
BEGIN
...
COMMENT ON FUNCTION public.get_complete_schema() IS 'Retorna o schema completo do banco de dados de forma segura com search_path definido';